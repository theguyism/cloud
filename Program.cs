...
namespace SimulatedDevice
{
    ...
    internal class Program
    {
        ...
        private static async Task SendDeviceToCloudMessagesAsync(CancellationToken ct)
        {
            ...
            int minFanspeed = 1;
            int maxFanspeed = 5;
            string name = "Welcome to My First Azure Web Application";
            var rand = new Random();
            ...
            while (!ct.IsCancellationRequested)
            {
                ...
                double currentSoundLv = rand.Next(minSoundLv,maxSoundLv);
                double currentLux = rand.NextDouble() + rand.Next(0,99);
                double currentCurrent = rand.NextDouble() + rand.Next(0,999);
                int currentFanspeed = rand.Next(minFanspeed, maxFanspeed);
                bool currentLightstatus = Convert.ToBoolean(rand.Next(0,1));
                ...
                message.Properties.Add("soundAlert", (currentSoundLv >= 150) ? "true" : "false");
